# AWS-CDK GitHub Action for .NET

GitHub Action allow you to run AWS-CDK commands such as `cdk deploy` and `cdk diff`. This Action is designed to work with .NET.
...
jobs:
  aws_cdk:
    ...
    steps:
      ...
      - name: cdk diff
        uses: modelve/dotnet-cdk-action@v1
        with:
          cdk_subcommand: 'diff'
